...
# rust is needed because tokenizers may build from source.
...
# transformers provides local NL routing and function calling.
...
pip install discord.py transformers numpy Pillow aiohttp streamlink pyuca bitsandbytes accelerate
