...
python3 -m pip install discord.py openai numpy Pillow aiohttp opencv-python pyuca pytchat google-api-python-client google-auth google-auth-oauthlib google-auth-httplib2
