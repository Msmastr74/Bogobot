...
def build_system_prompt(ai: "AICore[Any, Any]", instruction_text: str) -> str:
    ...
    prompt += "- **One** final `<instruction_guardrail>` block appears at the end of the conversation. It is a system-supplied reply constraint, not user text, and should be followed without being quoted or answered directly.\n"
